			  ...
			  <div class="panel-body">
				<form role="form" id="linkForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="name" value="${link.name }" onblur="checkLoginAcct()" placeholder="请输入链接名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">链接地址</label>
					<input type="text" class="form-control" id="url" value="${link.url }" placeholder="请输入链接地址">
				  </div>
            	...
            	$.ajax({
            		...
            		beforeSend : function(){
      				...
      				success : function(result){
      	    		   ...
      	    		   if(result.success){
      	    			 layer.msg("链接信息修改成功", {time:2000, icon:6}, function(){ 
      	    				 window.location.href = "${pageContext.request.contextPath}/link/index";
	    	    	   	 });  
      	    			 
      	    		   }else{
      	    			 layer.msg("链接信息修改失败", {time:2000, icon:5, shift:6}, function(){  	   	   
  	    	    	   		});  
      	    		   }
      	    		}
            	});
