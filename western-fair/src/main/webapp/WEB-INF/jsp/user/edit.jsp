			  ...
			  <div class="panel-body">
				<form id="userForm" role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="loginacct" value="${user.loginacct }" placeholder="请输入登录账号">
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="phone" value="${user.phone}" placeholder="请输入联系电话">
				  </div>
				  <div class="form-group">
