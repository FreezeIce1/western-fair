			  ...
			  <div class="panel-body">
				<form role="form" id="roleForm" class="form-inline">
				  ...
				  <div class="form-group">
					...
					<select id="leftList" name="unassignroleids" class="form-control" multiple size="10" style="width:180px;overflow-y:auto;">
				  ...
				  <div class="form-group" style="margin-left:40px;">
					...
					<select id="rightList" name="assignroleids" class="form-control" multiple size="10" style="width:180px;overflow-y:auto;">
        ...
        <script type="text/javascript">
            $(function () {
			    		...
			    		$.ajax({
			    			...
			    			success : function(result){
			    				if(result.success){
			    					...
			    					layer.msg("用户角色分配成功", {time:2000, icon:6}, function(){
			    						
					    	    	});
			    				}else{
			    					layer.msg("用户角色分配失败", {time:2000, icon:5, shift:6}, function(){  	   	   
					    	    	   });
			    				}
			    			}
			    		});
			    ...
			    $("#rightToLeftBtn").click(function(){
			    	...
			    	if(opts.length == 0){
			    		layer.msg("请选择要取消分配的角色数据", {time:2000, icon:5, shift:6}, function(){  	   	   
		    	    	   });
			    	}else{
			    		//发送ajax请求真正改变数据库中的用户角色信息
			    		$.ajax({
			    			...
			    			success : function(result){
			    				if(result.success){
			    					...
			    					layer.msg("用户角色取消分配成功", {time:2000, icon:6}, function(){
			    						
					    	    	});
			    				}else{
			    					layer.msg("用户角色取消分配失败", {time:2000, icon:5, shift:6}, function(){  	   	   
					    	    	   });
			    				}
			    			}
			    		});
