			  ...
			  <div class="panel-body">
				<form id="activityForm" role="form">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="name" placeholder="请输入活动名称">
				  	</div>
				  	<div class="form-group">
				  	...
				  	<div class="form-group">
						...
						<input type="email" class="form-control" id="time" placeholder="请输入活动时间">
						<p class="help-block label label-warning">请按照指定的时间格式输入(2018-09-20 10:00) </p>
				  	</div>
				  	<div class="form-group">
						<label for="exampleInputDate">活动介绍</label>
						<input type="text" class="form-control" id="introduce" placeholder="请输入活动介绍">
				  	</div>
	...
	<script src="${pageContext.request.contextPath}/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#insertBtn").click(function(){
            	...
            	$.ajax({
            		type : "POST",
            		url	 : "${pageContext.request.contextPath}/activity/insert",
            		data :{
            			"name" : $("#name").val(),
            			"address" : $("#address").val(),
            			"time"  : $("#time").val(),
            		...
            		beforeSend : function(){
      				...
      				success : function(result){
      	    		   ...
      	    		   if(result.success){
      	    			 layer.msg("活动信息保存成功", {time:2000, icon:6}, function(){ 
      	    				 window.location.href = "${pageContext.request.contextPath}/activity/index";
	    	    	   	 });  
      	    			 
      	    		   }else{
      	    			 layer.msg("活动信息保存失败", {time:2000, icon:5, shift:6}, function(){  	   	   
  	    	    	   		});  
      	    		   }
      	    		}
            	});
