        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="partnerTypeForm" role="form">
				<input type="hidden"class="form-control" id="typeid" value="${partnerType.typeid}"  >
				  <div class="form-group">
					<label for="exampleInputPassword1">类别名称</label>
					<input type="text" class="form-control" id="typename" value="${partnerType.typename}" placeholder="请输入类别名称">
				  </div>
	...
	<script src="${pageContext.request.contextPath}/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#updateBtn").click(function(){
            	...
            	$.ajax({
            		type : "POST",
            		url	 : "${pageContext.request.contextPath}/partnerType/update",
            		data :{
            			"typeid":  $("#typeid").val(),
